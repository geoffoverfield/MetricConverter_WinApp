                ...
                case Utils.Enumerations.ConversionType.Speed:
                    ...
                    switch (fromSpeedUnits)
                    {
                        case Units.SpeedUnits.Feet_Second:
                            ...
                            {
                                case Units.SpeedUnits.Feet_Second:
                                    sReturn = string.Format("{0}", Math.Round(input, 4));
                                    break;
                                case Units.SpeedUnits.Miles_Hour:
                                    sReturn = string.Format("{0}", Math.Round(input / 1.4667, 4));
                                    break;
                                case Units.SpeedUnits.Meters_Second:
                                    sReturn = string.Format("{0}", Math.Round(input / 3.281, 4));
                                    break;
                                case Units.SpeedUnits.Kilometers_Hour:
                                    sReturn = string.Format("{0}", Math.Round(input * 1.09728, 4));
                                    break;
                                default: sReturn = Utils.Consts.NaN;
                                    break;
                            }
                        ...
                        case Units.SpeedUnits.Miles_Hour:
                            switch (toSpeedUnits)
                            {
                                ...
                                case Units.SpeedUnits.Miles_Hour:
                                    ...
                                    break;
                                case Units.SpeedUnits.Meters_Second:
                                    sReturn = string.Format("{0}", Math.Round(input / 2.237, 4));
                                    break;
                                case Units.SpeedUnits.Kilometers_Hour:
                                    sReturn = string.Format("{0}", Math.Round(input * 1.609, 4));
                                    break;
                                default: sReturn = Utils.Consts.NaN;
                                    break;
                            }
                        ...
                        case Units.SpeedUnits.Meters_Second:
                            switch (toSpeedUnits)
                            {
                                ...
                                case Units.SpeedUnits.Meters_Second:
                                    ...
                                    break;
                                case Units.SpeedUnits.Kilometers_Hour:
                                    sReturn = string.Format("{0}", Math.Round(input * 3.6, 4));
                                    break;
                                default: sReturn = Utils.Consts.NaN;
                                    break;
                            }
